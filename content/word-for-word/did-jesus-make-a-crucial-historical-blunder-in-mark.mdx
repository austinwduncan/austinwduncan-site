...
date: "2026-02-05"
excerpt: "Critics rank Mark 2:26 near the top of alleged Bible errors: Jesus says David ate the consecrated bread \"in the days of Abiathar the high priest,\" but 1 Samuel 21 names Ahimelech. Austin Duncan walks through the underlying story, David's flight to Nob, Saul's slaughter of the priests, and Abiathar's escape to David, before turning to the Greek phrase itself. The preposition with the genitive can mark a broad era or even a section of Scripture, paralleled by Luke 3:2 and Romans 11:2. Add the likely Aramaic behind the saying, Abiathar's far greater name recognition, his place in the same priestly household, and the wider David narrative Jesus is invoking, and the supposed blunder dissolves into ordinary ancient speech."
tags: ["New Testament Issues"]
image: "/images/Word for Word/Word for Word - Episode 58.jpg"
---
