...
date: "2026-03-05"
excerpt: "The question of who picked the New Testament books is answered by walking through the actual historical record. Rather than a council choosing favorites, the evidence shows a community recognizing writings that already carried their own weight. Paul directed that his letters be circulated and read publicly, and Peter placed them alongside \"the other Scriptures.\" Ignatius, Polycarp, and Justin Martyr show the Gospels and Pauline letters functioning as Scripture by the early second century, and the Muratorian Fragment gives a list close to ours by A.D. 170. Marcion's attempt to impose a canon by personal authority was rejected. Origen and Eusebius narrow the disputed edges, and Athanasius, Hippo, and Carthage confirm what churches already held. Authority, not authoritarianism."
tags: ["New Testament Issues"]
image: "/images/Word for Word/Word for Word - Episode 62.jpg"
---
