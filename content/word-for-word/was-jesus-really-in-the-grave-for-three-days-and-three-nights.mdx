...
date: "2026-02-26"
excerpt: "Counting from Friday evening to Sunday morning yields two nights, not three, and Jesus staked His credibility on that prediction. Austin Duncan works the problem by asking how first century Jews actually counted time. Any part of a day counted as a whole day, days ran sunset to sunset, and \"three days and three nights\" functioned as a Hebrew idiom rather than a stopwatch measurement. Esther, Genesis 42, 1 Samuel 30, 1 Kings 12, and Hosea 6 all equate \"three days\" with \"on the third day.\" The Gospels use five different phrases for the same event, and the burial timeline fits Friday, Saturday, Sunday as three calendar days. The wider lesson: read Scripture on its own cultural terms."
tags: ["New Testament Issues"]
image: "/images/Word for Word/Word for Word - Episode 61.jpg"
---
