...
date: "2025-08-13"
excerpt: "Austin Duncan takes up the question underneath everything else Christians believe: is Scripture God-breathed or merely human? He argues no single proof settles it, but multiple independent lines converge like evidence in a criminal case. First, manuscripts: roughly 5,700 Greek copies of the New Testament against a handful for Plato, Caesar, and Thucydides, with early fragments and variant rates around half a percent. The Dead Sea Scrolls show the Old Testament text preserved almost word for word across a thousand years. Then prophecy: Messianic predictions Jesus could not have staged, Stoner's probability calculation, the fall of Tyre, Daniel's empires, and modern Israel. The episode moves into archaeology, citing the Tel Dan Stele, the Pilate Stone, and excavated cities, and breaks off there."
tags: ["Basic Apologetics"]
image: "/images/Word for Word/Word for Word - Episode 33.jpg"
---
