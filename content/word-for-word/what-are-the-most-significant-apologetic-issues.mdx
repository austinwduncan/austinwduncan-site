...
date: "2025-08-06"
excerpt: "Faith crises rarely turn on obscure doctrine. Austin Duncan argues that almost every one traces back to four questions: does God exist, why is there evil, can we trust the Bible, and did Jesus rise. Grounding the task in 1 Peter 3:15 and Paul at Athens, he frames apologetics as clearing rocks off the path rather than winning arguments. Most of the space goes to the first issue, laying out the cosmological, design, and moral arguments and their cumulative force, with help from Cooper, Collins, Craig, and Lewis. He then turns to suffering, separating the logical from the emotional problem, citing Plantinga, and beginning the free will defense and soul-making theodicy. The remaining two issues are deferred to later episodes."
tags: ["Basic Apologetics"]
image: "/images/Word for Word/Word for Word - Episode 32.jpg"
---
