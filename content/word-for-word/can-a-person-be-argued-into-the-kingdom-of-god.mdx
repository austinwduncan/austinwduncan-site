...
date: "2025-07-30"
excerpt: "Two people hear the same case for Christianity and only one believes. Working from John 6:44, 1 Corinthians 2 and 3, and Romans 10, Duncan argues that conversion is both God's work and a real human response, and that it often unfolds as a process rather than a single dramatic moment. He describes the web of influences behind most conversions, then walks through four kinds of resistance: intellectual objections that often mask deeper wounds, moral unwillingness to surrender control, emotional injury from pain and church hurt, and the spiritual enmity only the Spirit can break. Apologetics is compared to a snowplow: it clears obstacles but does not save. Illustrated throughout with pastoral conversations and C. S. Lewis."
tags: ["Basic Apologetics"]
image: "/images/Word for Word/Word for Word - Episode 31.jpg"
---
