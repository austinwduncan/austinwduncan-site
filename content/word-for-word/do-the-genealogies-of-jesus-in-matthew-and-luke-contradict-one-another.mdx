...
date: "2026-02-19"
excerpt: "Matthew traces Jesus through Solomon in forty-one names arranged in three sets of fourteen; Luke runs backward through Nathan across seventy-six names to Adam and to God. Duncan first makes the reader feel the problem, including the sharpest detail: Joseph's father is Jacob in Matthew and Heli in Luke. He then argues the trouble lies in modern assumptions rather than the texts, walking through the conventions that governed ancient genealogies. They were legal and theological instruments, not exhaustive biological records; adoption and levirate marriage placed men in more than one line; skipped generations were normal, as Matthew's omission of three kings shows; numbers carried symbolic weight, with fourteen encoding David's name. The transcript breaks off partway through the principle that \"son of\" need not mean biological son."
tags: ["New Testament Issues"]
image: "/images/Word for Word/Word for Word - Episode 60.jpg"
---
...
![An ancient Babylonian clay tablet documenting a legal adoption, around 546 BC. Records like this show that ‘son of’ in ancient genealogies could reflect legal relationships, not just biological ones.](/images/Sermons/Sermon Reference Images/egibi-family-bablyonian-clay-tablet.png)
