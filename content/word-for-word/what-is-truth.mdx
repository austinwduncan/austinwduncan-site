...
title: "What is truth?"
date: "2025-09-24"
excerpt: "Austin Duncan opens with the gap between courtroom oaths and classroom relativism, noting that nobody actually lives as though truth were optional. He recovers the classical definition from Aristotle and Aquinas, truth as correspondence between mind and reality, then surveys Barna and Arizona Christian University findings showing how few Americans, including professing Christians, hold to absolute truth. The heart of the argument is that relativism refutes itself, illustrated through conversations with a college student and a high schooler pressed on whether torturing babies is always wrong. Jesus' claim in John 14:6 is set against other religious founders, with word studies on aletheia and emet. Everyday examples from GPS, medicine, science, law, and language show truth is already assumed. The text breaks off partway into the tolerance objection."
tags: ["Basic Apologetics"]
image: "/images/Word for Word/Word for Word - Episode 39.jpg"
---
