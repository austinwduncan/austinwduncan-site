...
date: "2025-10-08"
excerpt: "A response to the popular charge that faith is history's chief killer. Austin Duncan grants the honest part of the accusation, then argues the roots run deeper: the fallen human heart, the corruption of power, ideological extremism, and false religion that Jesus Himself condemned in Matthew 7. None of the four requires belief in God. He then turns to the numbers, noting that the Encyclopedia of Wars classifies fewer than 7% of 1,763 wars as primarily religious, while the twentieth century's atheistic regimes under Stalin, Mao, and Pol Pot killed on a scale no religious war approaches. The Crusades, Inquisition, and modern terrorism are named plainly rather than excused. The verdict: religion is often the excuse for evil, not its cause, since the line between good and evil runs through every heart."
tags: ["Basic Apologetics"]
image: "/images/Word for Word/Word for Word - Episode 41.jpg"
---
