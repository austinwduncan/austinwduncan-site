...
date: "2025-12-11"
excerpt: "The charge that God manipulated Pharaoh and then punished him for it gets tested against the actual shape of the Exodus narrative. Austin Duncan tracks the hardening language across the plagues, noting that early references describe Pharaoh hardening himself while divine hardening grows more prominent after repeated refusals. Prediction, he argues, is not coercion; God knows Pharaoh's character and prepares Moses for a long showdown. Three Hebrew verbs are examined: a heart that becomes set, heavy, and rigid. Pharaoh is shown to be no blank slate but an oppressor who dismisses Yahweh outright in Exodus 5:2, so hardening functions as judgment confirming a chosen path. Romans 9 frames the discussion, holding sovereignty and responsibility together without resolving the tension away."
tags: ["Old Testament Issues"]
image: "/images/Word for Word/Word for Word - Episode 50.jpg"
---
