...
date: "2021-08-30"
excerpt: "Shifting the question from whether a church is perfect to whether it is faithful, this sermon works through the sixth letter of Revelation, addressed to Philadelphia. It sets the scene in a pagan wine-trading city on a Roman road, then unpacks the threefold description of Christ in verse 7, tracing the key of David back to Isaiah 22:22 and arguing that holy means divine, true means authentic, and the keys mean authority no crisis can overturn. The open door of verse 8 is read as opportunity and service rather than salvation, with Paul's language in 1 Corinthians 16 in support. A personal account of waiting years for a call into ministry illustrates that God opens doors and supplies strength to the weak, while our part is faithfulness to Scripture and to Christ's name."
tags: ["Sermons"]
youtube: "FFijjzLIieg"
image: "/images/Sermons/3 - Sermons - The Church of the Open Door.png"
...
![](/images/Sermons/Sermon Reference Images/1655752470120.jpg) 
