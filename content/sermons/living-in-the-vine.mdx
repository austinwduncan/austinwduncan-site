...
date: "2021-09-05"
excerpt: "Working carefully through John 15:1-11, this teaching asks why Jesus chose a vine and answers from the Old Testament, where Israel is the vine God planted and looked to for justice and righteousness but found none. Against that backdrop Christ's claim to be the true vine lands with force. Fruit, then, is not first a tally of souls won or money raised but the inward graces of the Spirit named in Galatians 5, and the piece calls for honest self-examination on that harder test. Pruning follows: drawn from the author's own horticulture study and from Psalm 119 and Hebrews 12, affliction is vinedressing rather than punishment. It closes on abiding as dependence on Christ through the Spirit."
tags: ["Hebrews", "John", "Isaiah", "Jeremiah", "Psalms", "Sermons"]
youtube: ""
image: "/images/Sermons/4 - Sermons - Living in the Vine.png"
