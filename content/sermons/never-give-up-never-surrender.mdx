...
date: "2024-09-02"
excerpt: "Preached as part of a \"Back At It\" series, this message takes up the fear that returning to faith after drifting is too steep a climb. Paul himself says he has not arrived, and that admission becomes the doorway: the journey of faith is ongoing, and the goal is direction rather than perfection. Two kinds of humility are distinguished, the sort that quits because it will never measure up, and the sort that keeps practising. From there the text turns to what must be left behind, both the accomplishments Paul counted as rubbish and the failures that make us hesitant, followed by the runner straining toward the finish. Illustrations from Galaxy Quest, a violinist, and a coin collection carry the points. Direct questions press listeners to name what they are clinging to for identity."
tags: ["Philippians", "Sermons", "Back At It"]
youtube: "uqtSG1F4WMo"
image: "/images/Sermons/34 - Sermons - Never Give Up Never Surrender.jpg"
