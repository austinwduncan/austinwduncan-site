...
date: "2025-11-17"
excerpt: "Mark's crucifixion account is traced through five successive rounds of mockery: the Roman cohort with purple robe and thorns, the road to Golgotha where Simon of Cyrene is compelled to carry the beam, the crucifixion and the dividing of clothes, the passersby wagging their heads, and finally the religious leaders. The recurring point is that the taunts were unwittingly accurate. Their sneer that he saved others but cannot save himself is treated as the gospel in a single line: not powerlessness, but refusal to abandon sinners. Historical background on scourging, crucifixion, and the wine mixed with myrrh grounds the horror, and Psalm 22 shows the plan behind it. It closes by naming us as soldiers, passersby, and demanding skeptics, then setting the two criminals side by side as the choice before every hearer."
tags: ["Isaiah", "John", "Acts", "Romans", "2 Corinthians", "Ephesians", "1 Timothy", "James", "1 Peter"]
youtube: "sl16pmHldzE"
image: "/images/Sermons/42 - Sermons - The King Who Couldnt Save Himself.png"
