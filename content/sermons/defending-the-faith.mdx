...
date: "2023-06-26"
excerpt: "A pastor opens a short series on Jude by reading out nineteen hard things that have hit his household since COVID: cancer diagnoses, a father in a coma, car wrecks, a flooded house, dogs nearly dying. The point is not sympathy but recognition that trouble arrives unscheduled and piles up, and that most listeners could write a similar list. From there the message turns to Jude's opening line, where the author identifies himself by two relationships: brother of James, and servant of Jesus Christ. The Greek doulos means slave, and the preacher presses how uncomfortable and how honorable that title is, placing Jude alongside Abraham, Moses and David, and contrasting it with a culture that prizes answering to no one. Christian maturity, he argues, shows up in the third word of the letter."
tags: ["Jude", "Sermons", "Wolves: The Book of Jude"]
youtube: "xB0pWyaIVAg"
image: "/images/Sermons/21 - Sermons - Defending the Faith.jpg"
