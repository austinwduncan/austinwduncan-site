...
date: "2026-05-04"
excerpt: "James 5:1-6 reads less like financial advice and more like a courtroom scene, and this teaching follows that image closely. The abrupt \"come now\" and the prophet's word \"howl\" set the tone, then three exhibits are examined: rotted riches, garments eaten quietly in storage while workers cry out for withheld wages, and gold that supposedly cannot corrode yet already has in God's sight. The point is not that money is evil but that hoarded wealth stops being neutral and starts testifying. \"Laid up treasure in the last days\" is read as moral urgency rather than prophecy chart, echoing the rich fool of Luke 12. The application turns to affluent hearers who compare sideways and never feel rich, weighed against global and historical measures of wealth."
tags: ["Isaiah", "John", "Acts", "Romans", "2 Corinthians", "Ephesians", "1 Timothy", "James", "1 Peter"]
youtube: "KmGI-k8PjoY"
image: "/images/Sermons/47 - Sermons - When Wealth Takes the Stand.png"
