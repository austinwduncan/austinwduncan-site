...
date: "2025-12-29"
excerpt: "A post-Christmas sermon on Luke 2:22-38, opening with the Chick-fil-A \"First 100\" overnight campout as a picture of what we rearrange our lives to be present for. Working through the passage, it examines Simeon as \"righteous and devout\" (dikaios and eulabes), his active waiting (prosdechomenos) for the consolation of Israel promised in Isaiah 40, and the Spirit's leading him into the temple at exactly the right hour. Simeon's peace comes from seeing Jesus rather than fixed circumstances; his warning to Mary about the sword and the fall and rising of many shows that Jesus forces a decision and exposes hearts. Anna, widowed and worshiping with fasting and prayer, shows that pain need not become identity."
tags: ["Isaiah", "John", "Acts", "Romans", "2 Corinthians", "Ephesians", "1 Timothy", "James", "1 Peter"]
youtube: "QfIsynJvLO4"
image: "/images/Sermons/44 - Sermons - Those Who Didn't Miss Him.jpg"
