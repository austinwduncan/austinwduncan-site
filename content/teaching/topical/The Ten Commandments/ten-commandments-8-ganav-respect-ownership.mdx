...
date: "2024-10-29"
excerpt: "A study of Exodus 20:15 in the \"Old Laws for a New Life\" series on the Ten Commandments. Working from the Hebrew ganav, which denotes secretive taking that betrays trust, the study traces the word through Jacob's flight from Laban in Genesis 31 and Absalom stealing the hearts of Israel in 2 Samuel 15, showing theft reaching past property into loyalty and social order. John Walton's background commentary connects property to a family's ability to fulfill its calling. Case laws on restitution, kidnapping, wage theft, boundary stones, and pledges widen the scope. Thomas Watson's four roots (unbelief, covetousness, laziness, pride) are applied to time theft, plagiarized sermons, padded expense reports, and dignity theft, with Mark 7:21-22 and Jeremiah 17 locating theft in the heart."
tags: ["Exodus", "Old Laws for a New Life"]
image: "/images/Teaching Series/Topical/Old Laws for a New Life/Commandment 8.jpg"
---
