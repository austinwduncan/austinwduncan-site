...
date: "2025-07-29"
excerpt: "Part one of a study on the Abrahamic covenant, set in week three of a twelve-week series on the biblical covenants. The teaching begins with the covenant ceremony of Genesis 15, then steps back to place Abram in his world: a moon-worshipping city, a family that served other gods, a barren wife, and no qualifications to speak of. Attention then turns to Genesis 12, where the emphatic Hebrew command to go is issued without a destination. The sevenfold promise is examined promise by promise, with weight given to the five occurrences of \"bless\" answering the five curses of Genesis 3 to 11. The text ends mid-exposition, having covered the first five promises."
tags: ["The Covenant"]
