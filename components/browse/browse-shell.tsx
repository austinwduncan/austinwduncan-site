              ...
              <div className="max-w-xl">
                ...
                {billboard.blurb && (
                  <p className="mt-4 line-clamp-2 text-[1rem] leading-relaxed"
                    style={{ fontFamily: 'var(--font-cmg), system-ui, sans-serif', color: 'rgba(255,255,255,0.76)' }}>
                    {billboard.blurb}
                  </p>
                )}
        ...
        <div className="lg:grid lg:grid-cols-[13rem_minmax(0,1fr)] lg:gap-14">
          <nav aria-label="Channels" className="lg:sticky lg:top-24 lg:self-start">
            <p
              ...
              style={{ fontFamily: HEADING, color: 'rgba(255,255,255,0.35)' }}
            >
              Channels
            </p>
            ...
            <div className="mt-8 hidden border-t pt-6 lg:block" style={{ borderColor: 'rgba(255,255,255,0.1)' }}>
              <Link
                href="/library"
                className="group inline-flex items-center gap-2 text-[0.68rem] font-semibold uppercase tracking-[0.12em]"
                style={{ fontFamily: HEADING, color: 'rgba(255,255,255,0.55)' }}
              >
                The Library
                <ArrowRight size={12} className="transition-transform duration-300 group-hover:translate-x-0.5" />
              </Link>
              <p className="mt-2 text-[0.78rem] leading-relaxed"
                style={{ fontFamily: 'var(--font-cmg), system-ui, sans-serif', color: 'rgba(255,255,255,0.35)' }}>
