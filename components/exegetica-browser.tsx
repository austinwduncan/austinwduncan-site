...
// Exported so page.tsx and [slug]/page.tsx can use the slug→collection mapping
export const COLLECTION_DEFS = [
  {
    id: 'hermeneutics',
    title: 'Hermeneutics & Method',
    subtitle: 'Reading Scripture faithfully across the canon',
    desc: 'How should Scripture be read? These studies address the principles and methods by which Christians interpret the Bible faithfully — from patristic allegory to canonical criticism to the New Testament\'s use of the Old.',
    slugs: [
  ...
  },
  {
    ...
    desc: "The letters of Paul reveal a sophisticated theology of law, covenant, and grace. These studies examine his key arguments — justification, covenantal membership, the role of the law — and their ongoing significance for the church.",
    slugs: [
  ...
  },
  {
    ...
    desc: 'From creation to consummation, these studies trace the grand narrative of redemptive history — the kingdom of God, the covenant framework, the temple motif, and the eschatological hope that shapes present Christian practice.',
    slugs: [
  ...
  },
  {
    ...
    desc: 'Who is Christ in the Scriptures? These studies trace his identity through the Hebrew Bible and early Jewish thought — the divine council, angelomorphic traditions, the Son of Man, and the Servant Songs — into New Testament Christology.',
    slugs: [
  ...
  },
  {
    ...
    desc: 'Visions, symbols, and divine unveiling — these studies explore the genre of apocalyptic literature through the shared imagery and divergent meanings of Ezekiel and Revelation, and what they reveal about God\'s purposes in history.',
    slugs: [
